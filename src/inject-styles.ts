...
export interface DockTheme {
  ...
  readonly resizerBg?: string;
  readonly resizerHv?: string;
...
// @var(--dock-focus) => resizer hover
function buildCssVars(theme: DockTheme): string {
  const t = { ...defaultTheme, ...theme };
  return `--dock-panel-bg:${t.panelBg};--dock-tab-bar-bg:${t.tabBarBg};--dock-tab-bg-color:${t.tabBg};--dock-tab-bg-active:${t.tabBgActive};--dock-tab-text-color:${t.tabTextColor};--dock-tab-padding-x:${t.tabPaddingX};--dock-tab-bar-min-height:${t.tabBarMinHeight};--dock-tab-bar-gap:${t.tabBarGap};--dock-handle-bg:${t.resizerBg};--dock-focus:${t.resizerHv};--dock-overlay-bg:${t.overlayBg};--dock-overlay-opacity:${t.overlayOpacity};--editor-icon-left-margin:${t.iconLeftMargin};--editor-icon-right-margin:${t.iconRightMargin};--editor-icon-right-opacity:${t.iconRightOpacity}`;
}
...
/** Custom theme styles */
const THEME_STYLES = `.lm-DockPanel{background-color:var(--dock-panel-bg);height:100%;width:100%}.lm-DockPanel .lm-TabBar{min-height:var(--dock-tab-bar-min-height);background-color:var(--dock-tab-bar-bg)}.lm-TabBar-content{height:100%;column-gap:var(--dock-tab-bar-gap);overflow-x:auto;overflow-y:hidden;flex:1 1 0;min-width:0}.lm-TabBar-tab{background-color:var(--dock-tab-bg-color);color:var(--dock-tab-text-color);align-items:center;padding:0 var(--dock-tab-padding-x);flex-shrink:0}.lm-DockPanel-handle{background-color:var(--dock-handle-bg)}.lm-DockPanel-overlay{background-color:var(--dock-overlay-bg);opacity:var(--dock-overlay-opacity)}.lm-mod-current{background-color:var(--dock-tab-bg-active)}.lumino-editor-icon{margin-right:var(--editor-icon-left-margin)}.lumino-close-editor-icon{margin-left:var(--editor-icon-right-margin);cursor:pointer;opacity:var(--editor-icon-right-opacity)}.lumino-close-editor-icon:hover{opacity:1}.lm-DockPanel-handle:hover {background-color: var(--dock-focus);}.lm-TabBar{display:flex!important;align-items:center!important;overflow:hidden}.lm-TabBar-toolbar{display:flex;align-items:center;gap:4px;padding:0 8px;flex-shrink:0}.lm-TabBar-content::-webkit-scrollbar{height:4px}.lm-TabBar-content::-webkit-scrollbar-track{background:var(--dock-tab-bar-bg)}.lm-TabBar-content::-webkit-scrollbar-thumb{background:var(--dock-handle-bg);border-radius:2px}.lm-TabBar-content::-webkit-scrollbar-thumb:hover{background:var(--dock-focus)}.lm-TabBar-content{-ms-overflow-style:none;scrollbar-width:none;padding-bottom:4px}.lm-TabBar-toolbar>*{border:none;background:transparent;color:var(--dock-tab-text-color);}`;
...
export const rawStyles = `:root{${buildCssVars(
  {}
)}}${LUMINO_CSS}${THEME_STYLES}`;
