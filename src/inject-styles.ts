...
/** Custom theme styles */
const THEME_STYLES = `.lm-DockPanel{background-color:var(--dock-panel-bg);height:100%;width:100%}.lm-DockPanel .lm-TabBar{min-height:var(--dock-tab-bar-min-height);background-color:var(--dock-tab-bar-bg)}.lm-TabBar-content{height:100%;column-gap:var(--dock-tab-bar-gap)}.lm-TabBar-tab{background-color:var(--dock-tab-bg-color);color:var(--dock-tab-text-color);align-items:center;padding:0 var(--dock-tab-padding-x)}.lm-DockPanel-handle{background-color:var(--dock-handle-bg)}.lm-DockPanel-overlay{background-color:var(--dock-overlay-bg);opacity:var(--dock-overlay-opacity)}.lm-mod-current{background-color:var(--dock-tab-bg-active)}.lumino-editor-icon{margin-right:var(--editor-icon-left-margin)}.lumino-close-editor-icon{margin-left:var(--editor-icon-right-margin);cursor:pointer;opacity:var(--editor-icon-right-opacity)}.lumino-close-editor-icon:hover{opacity:1}.lm-DockPanel-handle:hover {background-color: var(--dock-focus);}`;
